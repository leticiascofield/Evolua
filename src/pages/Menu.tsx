...
export default function Menu() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-pink-50 py-10 px-2 md:px-8 2xl:px-0">
      <div className="max-w-7xl mx-auto rounded-lg bg-white/90 shadow p-8 w-full">
        <h2 className="font-playfair text-xl text-pink-700 font-bold mb-2">Configurações</h2>
